...
final class HookLoader
{
     ...
     * @psalm-var array<class-string<\Churn\Event\Subscriber\HookDecorator>, class-string<AfterAnalysisHook>|class-string<AfterFileAnalysisHook>|class-string<BeforeAnalysisHook>>
     */
    private $decorators;
